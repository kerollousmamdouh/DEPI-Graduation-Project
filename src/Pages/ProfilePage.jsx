...
const UserProfile = () => {
  ...
  const handleEditKeyDown = (e, ticketId) => {
    if (e.key === "Enter" && !e.shiftKey) {
      e.preventDefault();
      handleSaveEditTicket(ticketId);
    }
  };
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full p-2.5 bg-white border border-gray-200 rounded-xl text-xs outline-none focus:border-green-500 focus:ring-2 focus:ring-green-500/5 transition-all"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] font-bold text-gray-500 mb-1 uppercase tracking-wide">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            className="w-full p-2.5 bg-white border border-gray-200 rounded-xl text-xs outline-none focus:border-green-500"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] font-bold text-gray-500 mb-1 uppercase tracking-wide">
                                        ...
                                        <div className="max-w-[85%] sm:max-w-[70%] space-y-1">
                                          ...
                                          isUser ? (
                                            ...
                                            <>
                                              ...
                                              {isUser &&
                                                isPending(ticket.status) &&
                                                editingTicketId !==
                                                  ticket.id && (
                                                  <div className="flex gap-2.5 text-[9px] text-gray-500 font-bold px-1 justify-end">
                                                    <button
                                                      type="button"
                                                      onClick={() => {
                                                        setEditingTicketId(
                                                    ...
                                                    <button
                                                      ...
                                                      className="hover:text-rose-500 flex items-center gap-0.5 transition-colors"
                                                    >
                                                      <Trash2 size={9} />{" "}
                                                      {isAr ? "حذف" : "Delete"}
                                                    </button>
                      ...
                      {selectedOrder.items.map((item, idx) => (
                        ...
                        >
                          ...
                          <span className="text-xs font-black text-green-600 shrink-0">
                            {renderText(item.price || item.currentPrice)} EGP
                          </span>
                        </div>
                      ))}
                    </div>
        ...
        {isMessageModalOpen && (
          <div className="fixed inset-0 bg-black/60 z-110 flex items-center justify-center p-3 backdrop-blur-xs">
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.95, opacity: 0 }}
              className="bg-white rounded-2xl max-w-md w-full p-4 sm:p-6 shadow-2xl text-start"
            >
